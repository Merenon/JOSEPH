...
public class InvalidCurveInfo implements IAttackInfo {
    ...
    private static final String id = "invalid_curve";

    // Full name of the attack
    private static final String name = "Invalid Curve";

    // Attack description
    private static final String description = "<html>The <em>Invalid Curve</em> attack aims to recover the private key of an elliptic curve cryptography setup by sending invalid curve points, which do not lie on the given curve.</html>";
    ...
    // List of InvalidCurveAttackRequest objects holding prepared attack
    // requests
    private List<InvalidCurveAttackRequest> requests = new ArrayList<>();
    ...
    @Override
    public InvalidCurve prepareAttack(IBurpExtenderCallbacks callbacks, IHttpRequestResponse requestResponse, IRequestInfo requestInfo,
