 ...
 * @version 1.0
 */
public class InvalidCurve implements IAttack {
    ...
    public void performAttack() {
        ...
        for (InvalidCurveAttackRequest attackRequest : this.attackInfo.getRequests()) {
    ...
    private class AttackExecutor extends SwingWorker<IHttpRequestResponse, Integer> {
        ...
        AttackExecutor(InvalidCurveAttackRequest attackRequest) {
